...
- (void)drawRect:(CGRect)rect
{
    ...
    //创建菜单按钮下划线
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0,  _pageControl.frame.size.height - 3, _pageControl.frame.size.width, 3)];//更改这里的值可以更改高度
...
#pragma mark 我自己写的改变title方法
//我自己写的方法，用来改变viewPager的titles啦
- (void)changeViewPageBtnTitle:(NSArray*)titleArr {
//    for (int i=0; i<buttonArr.count; i++) {
//        UIButton *myBtn = buttonArr[i];
//        [myBtn setTitle:titleArr[i] forState:UIControlStateNormal];
//    }
